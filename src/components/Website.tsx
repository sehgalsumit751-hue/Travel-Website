...
export default function SehgalTravelsLandingPage() {
  ...
  return (
    <>
      <Helmet>
        <title>
          Best Taxi Service In Amritsar Punjab | Sehgal Travels
        </title>
  
        <meta
          name="description"
          content="Sehgal Travels provides airport taxi service in Amritsar, Innova Crysta rental Punjab, Golden Temple cab booking, outstation taxi service, Chandigarh to Amritsar cab, Punjab tour packages, and luxury travel services."
        />
  
        <meta
          name="keywords"
          content="Taxi service Amritsar, Cab booking Punjab, Airport taxi Amritsar, Innova Crysta on rent Punjab, Golden Temple taxi service, Chandigarh to Amritsar cab, Outstation cab Punjab, Punjab tour packages, Sehgal Travels"
        />
